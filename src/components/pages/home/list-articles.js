...
onFavorit = (slug) =>{
  ...
  render(){
    console.log('State: ', this.props.articlesList)
  const {articlesList, loading} = this.props
  
    let classFavorit = ''
  if (articlesList.favorit){
  ...
  return(
    <ul>
      {
        articlesList.map(({slug, title, likes, favorit, taglist, createdAt, description, img, username}) =>{
          return(
            <li key={slug}>
                  ...
                  <div className="article-preview">
                      <div className="article-meta">
                          ...
                          <button 
                              ...
                              className={`btn btn-outline-primary btn-sm pull-xs-right btn-like ${classFavorit}`}
                                onClick={() => this.onFavorit(slug)} >
